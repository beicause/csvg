...
export const SvgSchema = {
  svg: {
    ...
    attributes: [
      ...
      },
      {
        name: 'class',
        description:
          'Assigns a class name or set of class names to an element. It functions identically to the [`class`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-class) attribute in HTML.  \r\n\n *Value*: Any valid ID string; *Animatable*: **Yes** [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/Styling)',
      ...
      },
      {
        name: 'style',
        description:
          'It specifies style information for its element. It functions identically to the [`style`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style) attribute in HTML.  \r\n\n *Value*: Any valid style string; *Animatable*: **No**\n \r\n\r\n\n  [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/Styling)',
        detail: 'svg styling attribute',
        options: null
      },
      {
  ...
  g: {
    ...
    detail: 'svg element',
    description:
      'The **`<g>`** [SVG](https://developer.mozilla.org/en-US/docs/Web/SVG) element is a container used to group other SVG elements. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/g)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  symbol: {
    ...
    detail: 'svg element',
    description:
      'The **`<symbol>`** element is used to define graphical template objects which can be instantiated by a [`<use>`](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/use "The <use> element takes nodes from within the SVG document, and duplicates them somewhere else.") element. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/symbol)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  use: {
    ...
    detail: 'svg element',
    description:
      'The **`<use>`** element takes nodes from within the SVG document, and duplicates them somewhere else. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/use)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  image: {
    ...
    detail: 'svg element',
    description:
      '<span class="seoSummary">The **`<image>`** SVG element includes images inside SVG documents. It can display [raster image](https://developer.mozilla.org/en-US/docs/Glossary/raster_image) files or other SVG files.</span> [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/image)',
    elements: [
      'desc',
      'title',
      'metadata',
    ...
    attributes: [
      ...
      },
      {
        name: 'clip-path',
        description:
          'It binds the element it is applied to with a given [`<clipPath>`](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/clipPath "The <clipPath> SVG element defines a clipping path, to be used used by the clip-path property.") element.  \r\n\n *Value*: **`none`**|[<FuncIRI>](/docs/Web/SVG/Content_type#FuncIRI)|`inherit`; *Animatable*: **Yes** [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/Presentation)',
        detail: 'svg presentation attribute',
        options: ['auto', 'inherit', 'none']
      },
      {
        name: 'clip-rule',
        description:
          'It indicates how to determine what side of a path is inside a shape in order to know how a [`<clipPath>`](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/clipPath "The <clipPath> SVG element defines a clipping path, to be used used by the clip-path property.") should clip its target.  \r\n\n *Value*: **`nonezero`**|`evenodd`|`inherit`; *Animatable*: **Yes** [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/Presentation)',
        detail: 'svg presentation attribute',
        options: ['evenodd', 'nonzero', 'inherit']
      },
      {
        name: 'cursor',
        description:
      ...
      },
      {
        ...
        description:
          'Hints about what tradeoffs to make as the browser renders [`<path>`](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/path "The <path> SVG element is the generic element to define a shape. All the basic shapes can be created with a path element.") element or basic shapes.  \r\n\n *Value*: `**auto**`|`optimizeSpeed`|`crispEdges`|`geometricPrecision` |`inherit`; *Animatable*: **Yes** [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/Presentation)',
        detail: 'svg presentation attribute',
        options: null
      },
      {
  ...
  style: {
    ...
    detail: 'svg element',
    description:
      'The SVG **`<style>`** element allows style sheets to be embedded directly within SVG content. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/style)',
    elements: [],
    attributes: [
      {
        name: 'id',
      ...
      },
      {
        name: 'media',
        description:
          'This attribute defines to which [`media`](https://developer.mozilla.org/en-US/docs/Web/CSS/@media "The documentation about this has not yet been written; please consider contributing!") the style applies.  \r\n\n *Value type*: [**<string>**](/docs/Web/SVG/Content_type#String); *Default value*: `all`; *Animatable*: **no** [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/style)',
        detail: 'svg item attribute',
        options: null
      },
      {
  ...
  path: {
    ...
    detail: 'svg element',
    description:
      'The **`<path>`** [SVG](https://developer.mozilla.org/en-US/docs/Web/SVG) element is the generic element to define a shape. All the basic shapes can be created with a path element. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/path)',
    elements: [
      'desc',
      'title',
      'metadata',
    ...
    attributes: [
      ...
      },
      {
        name: 'marker-start',
        description:
          'It defines the arrowhead or polymarker that will be drawn at the first vertex of the given [`<path>`](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/path "The <path> SVG element is the generic element to define a shape. All the basic shapes can be created with a path element.") element or basic shape.  \r\n\n *Value*: [<FuncIRI>](/docs/Web/SVG/Content_type#FuncIRI)|**`none`**|`inherit`; *Animatable*: **Yes** [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/Presentation)',
        detail: 'svg presentation attribute',
        options: ['none', 'inherit']
      },
      {
      ...
      },
      {
        name: 'marker-end',
        description:
          'It defines the arrowhead or polymarker that will be drawn at the final vertex of the given [`<path>`](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/path "The <path> SVG element is the generic element to define a shape. All the basic shapes can be created with a path element.") element or basic shape.  \r\n\n *Value*: [<FuncIRI>](/docs/Web/SVG/Content_type#FuncIRI)|**`none`**|`inherit`; *Animatable*: **Yes** [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/Presentation)',
        detail: 'svg presentation attribute',
        options: ['none', 'inherit']
      },
      {
  ...
  rect: {
    ...
    detail: 'svg element',
    description:
      'The **`<rect>`** element is a [basic SVG shape](https://developer.mozilla.org/en-US/docs/Web/SVG/Tutorial/Basic_Shapes) that draws rectangles, defined by their position, width, and height. The rectangles may have their corners rounded. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/rect)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  circle: {
    ...
    detail: 'svg element',
    description:
      'The **`<circle>`** [SVG](https://developer.mozilla.org/en-US/docs/Web/SVG) element is an [SVG basic shape](https://developer.mozilla.org/en-US/docs/Web/SVG/Tutorial/Basic_Shapes), used to draw circles based on a center point and a radius. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/circle)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  ellipse: {
    ...
    detail: 'svg element',
    description:
      'The **`<ellipse>`** element is an SVG basic shape, used to create ellipses based on a center coordinate, and both their x and y radius. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/ellipse)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  line: {
    ...
    detail: 'svg element',
    description:
      'The **`<line>`** element is an SVG basic shape used to create a line connecting two points. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/line)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  polygon: {
    ...
    detail: 'svg element',
    description:
      'The **`<polygon>`** element defines a closed shape consisting of a set of connected straight line segments. The last point is connected to the first point. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/polygon)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  text: {
    ...
    detail: 'svg element',
    description:
      "The SVG **`<text>`** element draws a graphics element consisting of text. It's possible to apply a gradient, pattern, clipping path, mask, or filter to `<text>`, like any other SVG graphics element. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/text)",
    elements: [
      'desc',
      'title',
      'metadata',
    ...
    attributes: [
      ...
      },
      {
        name: 'font-style',
        description:
          'It specifies whether a font should be styled with a normal, italic, or oblique face from its [`font-family`](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/font-family).  \r\n\n *Value*: **`normal`**|`italic`|`oblique`; *Animatable*: **Yes** [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/Presentation)',
        detail: 'svg presentation attribute',
        options: null
      },
      {
      ...
      },
      {
        ...
        detail: 'svg presentation attribute',
        options: ['baseline', 'sub', 'super', 'inherit']
      },
      {
        name: 'direction',
        description:
  ...
  tref: {
    ...
    elements: ['desc', 'title', 'metadata', 'animate', 'set', 'animateColor'],
    attributes: [
      {
        name: 'id',
        description:
  ...
  'color-profile': {
    ...
    detail: 'svg element',
    description:
      'The **`<color-profile>`** element allows describing the color profile used for the image. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/color-profile)',
    elements: ['desc', 'title', 'metadata'],
    attributes: [
      {
        name: 'id',
        description:
  ...
  linearGradient: {
    ...
    detail: 'svg element',
    description:
      'The **`<linearGradient>`** element lets authors define linear gradients that can be applied to fill or stroke of graphical elements. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/linearGradient)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  radialGradient: {
    ...
    detail: 'svg element',
    description:
      'The **`<radialGradient>`** element lets authors define radial gradients that can be applied to fill or stroke of graphical elements. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/radialGradient)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  pattern: {
    ...
    detail: 'svg element',
    description:
      'The **`<pattern>`** element defines a graphics object which can be redrawn at repeated x and y-coordinate intervals ("tiled") to cover an area. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/pattern)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  clipPath: {
    ...
    detail: 'svg element',
    description:
      'The **`<clipPath>`** [SVG](https://developer.mozilla.org/en-US/docs/Web/SVG) element defines a clipping path, to be used used by the [`clip-path`](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/clip-path) property. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/clipPath)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  mask: {
    ...
    detail: 'svg element',
    description:
      'The **`<mask>`** element defines an alpha mask for compositing the current object into the background. A mask is used/referenced using the [`mask`](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/mask) property. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/mask)',
    elements: [
      'desc',
      'title',
      'metadata',
  ...
  feFlood: {
    ...
    attributes: [
      ...
      },
      {
        name: 'flood-opacity',
        description:
          'It indicates the opacity value to use across the current filter primitive subregion defined through the [`<feFlood>`](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/feFlood "The <feFlood> SVG filter primitive fills the filter subregion with the color and opacity defined by flood-color and flood-opacity.") or [`<feDropShadow>`](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/feDropShadow "The SVG <feDropShadow> filter primitive creates a drop shadow of the input image. It can only be used inside a <filter> element.") element.  \r\n\n *Value*: [<number>](/docs/Web/SVG/Content_type#Number)|[<percentage>](/docs/Web/SVG/Content_type#Percentage); *Animatable*: **Yes** [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/Presentation)',
        detail: 'svg presentation attribute',
        options: null
      },
      {
  ...
  feImage: {
    ...
    detail: 'svg element',
    description:
      'The **`<feImage>`** [SVG](https://developer.mozilla.org/en-US/docs/Web/SVG) filter primitive fetches image data from an external source and provides the pixel data as output (meaning if the external source is an SVG image, it is rasterized.) [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/feImage)',
  ...
  feMerge: {
    ...
    detail: 'svg element',
    description:
      'The **`<feMerge>`** SVG element allows filter effects to be applied concurrently instead of sequentially. This is achieved by other filters storing their output via the [`result`](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/result) attribute and then accessing it in a [`<feMergeNode>`](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/feMergeNode "The feMergeNode takes the result of another filter to be processed by its parent <feMerge>.") child. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/feMerge)',
  ...
  feMergeNode: {
    ...
    detail: 'svg element',
    description:
      'The `feMergeNode` takes the result of another filter to be processed by its parent [`<feMerge>`](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/feMerge "The <feMerge> SVG element allows filter effects to be applied concurrently instead of sequentially. This is achieved by other filters storing their output via the result attribute and then accessing it in a <feMergeNode> child."). [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/feMergeNode)',
    elements: ['animate', 'set'],
    attributes: [
      {
        name: 'id',
  ...
  feMorphology: {
    ...
    detail: 'svg element',
    description:
      "The **`<feMorphology>`** [SVG](https://developer.mozilla.org/en-US/docs/Web/SVG) filter primitive is used to erode or dilate the input image. It's usefulness lies especially in fattening or thinning effects. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/feMorphology)",
    elements: ['animate', 'set'],
    attributes: [
      {
        name: 'id',
  ...
  view: {
    ...
    detail: 'svg element',
    description:
      'A view is a defined way to view the image, like a zoom level or a detail view. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/view)',
    elements: ['desc', 'title', 'metadata'],
    attributes: [
      {
        name: 'id',
  ...
  script: {
    ...
    detail: 'svg element',
    description:
      'The SVG `script` element allows to add scripts to an SVG document. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/script)',
    elements: [],
    attributes: [
      {
        name: 'id',
  ...
  animate: {
    ...
    detail: 'svg element',
    description:
      'The SVG **`<animate>`** element provides a way to animate an attribute of an element over time. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/animate)',
    elements: ['desc', 'title', 'metadata'],
    attributes: [
      {
        name: 'id',
  ...
  set: {
    ...
    detail: 'svg element',
    description:
      'The SVG **`<set>`** element provides a simple means of just setting the value of an attribute for a specified duration. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/set)',
    elements: ['desc', 'title', 'metadata'],
    attributes: [
      {
        name: 'id',
  ...
  animateMotion: {
    ...
    detail: 'svg element',
    description:
      'The SVG **`<animateMotion>`** element let define how an element moves along a motion path. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/animateMotion)',
    elements: ['desc', 'title', 'metadata', 'mpath'],
    attributes: [
      {
        name: 'id',
        description:
  ...
  animateColor: {
    ...
    detail: 'svg element',
    description:
      'The **`<animateColor>`** [SVG](https://developer.mozilla.org/en-US/docs/Web/SVG) element specifies a color transformation over time. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/animateColor)',
    elements: ['desc', 'title', 'metadata'],
    attributes: [
      {
        name: 'id',
  ...
  animateTransform: {
    ...
    detail: 'svg element',
    description:
      'The `animateTransform` element animates a transformation attribute on its target element, thereby allowing animations to control translation, scaling, rotation, and/or skewing. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/animateTransform)',
    elements: ['desc', 'title', 'metadata'],
    attributes: [
      {
        name: 'id',
  ...
  'font-face': {
    ...
    detail: 'svg element',
    description:
      'The **`<font-face>`** [SVG](https://developer.mozilla.org/en-US/docs/Web/SVG) element corresponds to the CSS [`@font-face`](https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face "The @font-face CSS at-rule specifies a custom font with which to display text; the font can be loaded from either a remote server or a locally-installed font on the user\'s own computer.") rule. It defines a font\'s outer properties. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/font-face)',
    elements: ['desc', 'title', 'metadata', 'font-face-src', 'definition-src'],
    attributes: [
      {
        name: 'id',
        description:
  ...
  foreignObject: {
    ...
    detail: 'svg element',
    description:
      'The **`<foreignObject>`** [SVG](https://developer.mozilla.org/en-US/docs/Web/SVG) element includes elements from a different XML namespace. In the context of a browser, it is most likely (X)HTML. [more...](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/foreignObject)',
    elements: [],
    attributes: [
      {
        name: 'id',
