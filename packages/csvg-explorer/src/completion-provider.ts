...
function getLastOpenedTag(
  text: string
): undefined | { tagName: SvgSchemaKey; isAttributeSearch: boolean } {
...
function getAvailableAttribute(
  monaco: typeof m,
  lastOpenedTag: { tagName: SvgSchemaKey; isAttributeSearch: boolean },
...
export function getXmlCompletionProvider(
  ...
  return {
    ...
    provideCompletionItems(
      model,
      position
    ): m.languages.ProviderResult<m.languages.CompletionList> {
...
export function getXmlHoverProvider(
  monaco: typeof m
  ...
  return {
    provideHover(
      ...
      position,
      token
    ): m.languages.ProviderResult<m.languages.Hover> {
